...
if __name__ == "__main__":
    ...
    parser.add_argument("-mode", help="Single or multi-class validation. Options are multi, single, default=multi.")
    parser.add_argument("-truth_label", help="Please provide the truth label for this dataset.", required=False)
    ...
    mode = args.mode if args.mode else "multi"
    ...
    if mode == "single":
        print(f"\tWe are validating single truth label: {truth_label}")
